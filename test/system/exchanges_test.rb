...
class ExchangesTest < ApplicationSystemTestCase
  ...
  test "creating a Exchange" do
    ...
    fill_in "Date of gifting", with: @exchange.date_of_gifting
    fill_in "Date of matching", with: @exchange.date_of_matching
    fill_in "Finish date", with: @exchange.finish_date
    fill_in "Title", with: @exchange.title
