...
class ExchangesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exchange" do
    assert_difference('Exchange.count') do
      post exchanges_url, params: { exchange: { date_of_gifting: @exchange.date_of_gifting, date_of_matching: @exchange.date_of_matching, finish_date: @exchange.finish_date, title: @exchange.title } }
    end
  ...
  test "should update exchange" do
    patch exchange_url(@exchange), params: { exchange: { date_of_gifting: @exchange.date_of_gifting, date_of_matching: @exchange.date_of_matching, finish_date: @exchange.finish_date, title: @exchange.title } }
